...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "journals/:id", element: <JournalDetailsPage /> },
...

      {
        ...
        children: [
          ...
          {
            path: "author/edit/:id",
            element: <AuthorSubmitPage />,
          },

          {
            path: "author/reviews/:id",
            element: <AuthorReviewsPage />,
          },
        ],
      },
...

      {
        ...
        children: [
          ...
          {
            path: "committee/content",
            element: <CommitteeContentPage />,
          },

          {
            path: "committee/issues",
            element: <CommitteeIssuesPage />,
          },
        ],
      },
